<%-- 
    ...
    Created on : 30/06/2022, 11:28:15 AM
    Author     : Alfredo
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  <!-- /meta tags -->
  <title>::Awkicare - Mantenimiento::</title>
    ...
    <aside id="main-sidebar" class="dt-sidebar">
      <div class="dt-sidebar__container">
        ...
        <ul class="dt-side-nav">
          ...
          <li class="dt-side-nav__item open selected">
            <a href="mantenimiento.jsp" class="dt-side-nav__link dt-side-nav__arrow" title="Configuración">
              ...
              <div class="dt-card">
                ...
                <div class="dt-card__header">
                  ...
                  <div class="dt-card__heading">
                    <h3 class="dt-card__title">Mantenimiento</h3><!--Titulo-->
                  </div>
                  <!-- /card heading -->
                </div>
                <!-- /card header -->
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" data-toggle="tab" href="#tab-pane-1" role="tab"
                         aria-controls="tab-pane-1" aria-selected="true"><i class="fas fa-cog"></i> General
                      </a>
                    </li>
                  </ul>
                  <!-- /tab navigation -->
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="dt-card">
                            ...
                            <div class="dt-card__header">
                              <!-- Card Heading -->
                              <div class="dt-card__heading">
                                <h3 class="dt-card__title">Personas</h3>
                              </div>
                              <!-- /card heading -->
                            </div>
                            <!-- /card header -->
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="dt-card">
                            ...
                            <div class="dt-card__header">
                              <!-- Card Heading -->
                              <div class="dt-card__heading">
                                <h3 class="dt-card__title">Nucleo</h3>
                              </div>
                              <!-- /card heading -->
                            </div>
                            <!-- /card header -->
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="dt-card">
                            ...
                            <div class="dt-card__header">
                              <!-- Card Heading -->
                              <div class="dt-card__heading">
                                <h3 class="dt-card__title">Finanzas</h3>
                              </div>
                              <!-- /card heading -->
                            </div>
                            <!-- /card header -->

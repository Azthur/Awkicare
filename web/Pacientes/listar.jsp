...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-pane-1" role="tab"
                       aria-controls="tab-pane-1" aria-selected="true"><i class="fas fa-user-injured"></i> Listado de Pacientes
                    </a>
                  </li>
                  <li class="nav-item">
                            ...
                            <table id="data-table" class="table table-hover dataTable dtr-inline">
                              ...
                              <c:forEach var="x" items="${lis}">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-warning" href="ControlPacientes?accion=modificar&idpacientes=${x.getIdpacientes()}"><i class="fas fa-pen"></i></a>
                                        <a class="btn btn-xs btn-danger" href="ControlPacientes?accion=eliminar&idpacientes=${x.getIdpacientes()}" onclick="return confirm('¿Desea Eliminar el registro?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <% i++; %>
                              </c:forEach>
  ...
  document.title = "::Awkicare:: - Pacientes"
</script>
                          </div>
                          <!-- /tables -->

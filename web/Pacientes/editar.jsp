...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  <!-- /meta tags -->
  <title>::Awkicare - Pacientes::</title>
            ...
            <div class="dt-card">
              ...
              <div class="dt-card__header">
                ...
                <div class="dt-card__heading">
                  <h3 class="dt-card__title">Mantenimiento Pacientes</h3><!--Titulo-->
                </div>
                <!-- /card heading -->
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-pane-1" role="tab"
                       aria-controls="tab-pane-1" aria-selected="true"><i class="fas fa-user-nurse"></i> Listado de Pacientes
                    </a>
                  </li>
                </ul>
                <!-- /tab navigation -->
                        ...
                        <div class="col-12">
                          ...
                          <div class="dt-card">
                            ...
                            <div class="dt-card__body">
                              ...
                              <!-- Form -->
                              <form class="" action="ControlPacientes" method="POST">
                                <div class="form-row">
                                    <div class="col-sm-3 mb-3">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-prepend">
                                          ...
                                          <input type="text" class="form-control" id="nombres" name="nombres" value="${paci.nombres}" readonly="readonly">
                                      </div>
                                    </div>
                                    <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="apellidos" name="apellidos" value="${paci.apellidos}" readonly="readonly">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-sm-3 mb-3">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="dni" name="dni" value="${paci.dni}" readonly="readonly">
                                      </div>
                                    </div>
                                ...
                                <div class="form-row">
                                  ...
                                  <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="date" class="form-control" id="nacimiento" name="nacimiento" value="${paci.nacimiento}">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="correo" name="correo" value="${paci.correo}">
                                    </div>
                                  </div>
                                  <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="telefono" name="telefono" value="${paci.telefono}">
                                      <input type="hidden" name="ubigeo" value="150101">
                                      <input type="hidden" name="idpacientes" value="${paci.idpacientes}"><br>
